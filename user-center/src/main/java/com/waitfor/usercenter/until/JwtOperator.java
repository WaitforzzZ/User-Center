package com.waitfor.usercenter.until;
...
public class JwtOperator {
    ...
    /*public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODc1MjM0MTUsImV4cCI6MTU4ODczMzAxNX0.E27UarKkJ10XKNynt34EmuSrCGLLOB1dZIfES8KN-IQ";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1ODc1MjM3ODgsImV4cCI6MTU4ODczMzM4OH0";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload));

        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODc1MjQyOTIsImV4cCI6MTU4ODczMzg5Mn0.8h51mEviVqjAth054d4yNTJI7qZQxFMNVH2ZXfUleEI");
    }*/
}
